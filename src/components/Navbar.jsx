      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link to="/partner">
              <button className="group cursor-pointer relative px-6 py-3 bg-white border-2 border-teal-600 rounded-xl font-bold text-teal-600 transition-all duration-300 flex items-center gap-2 hover:bg-teal-50 hover:scale-105 active:scale-95 overflow-hidden">
            ...
            <Link to="/sponsor">
              <button className="group relative cursor-pointer px-6 py-3 bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl font-bold text-white transition-all duration-300 flex items-center gap-2 shadow-lg shadow-teal-500/30 hover:shadow-xl hover:shadow-teal-500/50 hover:scale-105 active:scale-95 overflow-hidden">
