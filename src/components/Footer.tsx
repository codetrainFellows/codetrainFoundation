        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 flex items-center justify-center">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="20" cy="20" r="18" stroke="#00838f" strokeWidth="4"/>
              <circle cx="20" cy="20" r="8" stroke="#00838f" strokeWidth="3"/>
            </svg>
          </div>
          <div className="text-left">
            ...
            <span className="text-[#00838f] text-sm font-medium">Education Must Lead to Work.</span>
          </div>
        </div>

        {/* Contact Links */}
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 mb-8 mt-6">
          <div className="flex items-center gap-2">
            <span className="text-[#00838f]">📧</span>
            <a 
              href="mailto:empower@codetrainfoundation.org" 
              className="text-slate-600 hover:text-[#00838f] transition-colors font-semibold"
            >
