            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <Link to="/partner" className="block">
                  <button className="w-full cursor-pointer bg-white text-teal-900 px-6 md:px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-sm md:text-base">
                    Fund a Scholarship
                  </button>
                </Link>
                ...
                <Link
  to="/sponsor"
  className="cursor-pointer group relative overflow-hidden border-2 border-white/70 text-white px-6 md:px-8 py-4 rounded-lg font-semibold transition-all duration-300 text-sm md:text-base text-center backdrop-blur-sm hover:border-white hover:shadow-xl"
>
  <span className="absolute inset-0 bg-white/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>

  <span className="relative z-10 flex flex-col items-center leading-tight">
    <span className="tracking-wide">Sponsor a Student</span>
