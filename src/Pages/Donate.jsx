    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-50 py-16 px-4">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 px-4 justify-center">
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden max-w-xl">
          ...
          {/* Button */}
          <button className="relative w-full bg-blue-600 text-white font-semibold px-8 py-4 rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 flex items-center justify-center gap-2 group-hover:gap-4 shadow-lg hover:shadow-xl">
            Donate Now
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden max-w-xl">
          ...
          {/* Button */}
          <button className="relative w-full bg-linear-to-r from-amber-500 to-yellow-500 text-white font-semibold px-8 py-4 rounded-xl hover:from-amber-600 hover:to-yellow-600 transition-all duration-300 flex items-center justify-center gap-2 group-hover:gap-4 shadow-lg hover:shadow-xl">
            Become a Sponsor
            <ArrowRight size={20} className="transition-all duration-300" />
          </button>
        </div>
