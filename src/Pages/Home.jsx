  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="text-center mb-16 animate-fade-in">
      ...
      <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
        Your donation keeps this door of opportunity open for the next generation
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div className="group text-center transform transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-100">
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">Alumni</h3>
        <p className="text-6xl md:text-7xl font-bold text-blue-600">700<span className="text-4xl">+</span></p>
      ...
      <div className="group text-center transform transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-300">
        <div className="mx-auto w-16 h-16 mb-4 flex items-center justify-center rounded-full bg-green-100 text-green-600 group-hover:bg-green-600 group-hover:text-white transition-colors">
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6v3m-4-3v3m-4-3v3m5 6v3m-4-3v3m-4-3v3" />
          </svg>
        </div>
        <h3 className="text-xl font-semibold text-gray-800 mb-2">Job Placement</h3>
        <p className="text-6xl md:text-7xl font-bold text-green-600">89<span className="text-4xl">%</span></p>
      ...
      <div className="group text-center transform transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-500">
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">Student Rating</h3>
        <p className="text-6xl md:text-7xl font-bold text-amber-600">91<span className="text-4xl">%</span></p>
